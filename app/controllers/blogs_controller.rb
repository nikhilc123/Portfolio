class BlogsController < ApplicationController
  ...
  #performance, check comments inside topics_controller action
  before_action :set_sidebar_topics, except: [:new, :create, :destroy, :toggle_status]
  ...
  def index
    if !logged_in?(:site_admin)
      @blogs = Blog.draft.recent.page(params[:page]).per(5)
    else
